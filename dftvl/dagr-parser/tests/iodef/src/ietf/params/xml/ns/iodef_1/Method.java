 ...
 *           &lt;element ref="{urn:ietf:params:xml:ns:iodef-1.0}Reference"/>
    ...
    implements Serializable
{
    ...
    protected List<Serializable> referenceOrDescription;
     ...
     * 
     */
    public List<Serializable> getReferenceOrDescription() {
        if (referenceOrDescription == null) {
            referenceOrDescription = new ArrayList<Serializable>();
        }
